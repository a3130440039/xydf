...
if (!function_exists('build_toolbar')) {
    ...
    function build_toolbar($btns = null, $attr = [])
    {
        ...
        $btns = $btns ? $btns : ['refresh', 'add', 'edit', 'del', 'import', 'clear'];
        ...
        $btnAttr = [
            ...
            'clear'   => ['javascript:;', 'btn btn-danger btn-clear ', 'fa fa-trash', __('清空当前数据'), __('清空当前数据')],
...
function app_secret(){
    $dt = date('YmdHis');
    $str = $dt . substr(implode(NULL, array_map('ord', str_split(substr(uniqid(), 7, 13), 1))), 0, 9);
    return md5($str);
}
