...
return [
    ...
    //网址配置
    'url' =>[
        'orderUrl'              =>'http://gw.api.agiso.com/alds/Trade/TradeInfo'//阿奇索订单查询
    ],

    //阿奇索开发配置
    'agiso' =>[
        'appSecret' =>'9wwy792tu6uszmwa8pw82',
        'tradeUrl' =>'http://gw.api.agiso.com/alds/Trade/TradeInfo'
    ],
    ...
    //二维码解析依赖Java jdk地址
    'jdk' =>'/usr/java/jdk1.8.0_241/bin/java'
    //'jdk' =>'D:/Java/jdk-14/bin/java'
];
